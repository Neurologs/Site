...
def page_alzheimer():
    ...
    st.write("""<style>
                ...
                .st-ey, .st-ew {background-color:#fef3fe}
...
def MMSE_page():
    ...
    st.markdown("""<style>
                ...
                .css-1qpos38 {text-align:center; background-color:#12A67F; color:white; font-size:150%; width:445px; margin-right: 100px; margin-left: 100px; height:100px} 
