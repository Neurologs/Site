...
def page_alzheimer():
    ...
    st.write("""<style>
                ...
                .st-e0 {width: 30px} .st-e1 {height: 30px} .st-fo, .st-en, .st-ep {background-color: #12A67F} .st-eg {margin-left: 19px; margin-right: 14px;} 
...
def MMSE_page():
    ...
    st.markdown("""<style>
                ...
                .css-1qpos38 {text-align:center; background-color:#12A67F; color:white; font-size:150%; width:445px; margin-right: 100px; margin-left: 100px; height:80px} 
